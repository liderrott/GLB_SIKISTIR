...
import { inspect as inspect$1, listTextureSlots, getTextureColorSpace, mergeDocuments, dedup, unpartition, createTransform, getTextureChannelMask, fitWithin, fitPowerOfTwo, TextureResizeFilter, INSTANCE_DEFAULTS, PALETTE_DEFAULTS, SIMPLIFY_DEFAULTS, instance, palette, flatten, join as join$1, weld, simplify, resample, prune, sparse, textureCompress, draco, meshopt, quantize, partition, PRUNE_DEFAULTS, center, JOIN_DEFAULTS, DRACO_DEFAULTS, MESHOPT_DEFAULTS, QUANTIZE_DEFAULTS, dequantize, unweld, tangents, reorder, metalRough, unlit, TEXTURE_COMPRESS_SUPPORTED_FORMATS, sequence } from '@gltf-transform/functions';
